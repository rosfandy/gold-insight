      ...
      <div className="flex justify-center items-center md:px-32">
        <div className="flex w-full md:px-8 md:pt-40 pt-32">
          <div className="md:w-2/3 px-8 flex flex-col gap-y-4  justify-center">
            ...
            <p className="md:text-[18px] text-[14px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque iusto omnis quidem sint tempore nemo similique. Animi dolore, laborum incidunt asperiores perferendis maxime? Libero debitis explicabo ab in aspernatur quidem.</p>
            <div>
